...
<body
	...
	<div id="wrapper">
		...
		<div id="main-content" class="site-main light">
			...
			<!-- <div id="banner_2144429860" class="ux_banner  dark "
				style="height: 300px" data-height="300px" role="banner">
				<div class="banner-bg ux_parallax" data-velocity="0.5"
					style="background-image: url(http://flatsome.uxthemes.com/wp-content/uploads/sites/2/2013/08/blog-post-header1.jpg);"></div>
			...
			<div class="page-wrapper page-no-sidebar">
				<div class="row">
					...
					<div id="content" class="large-12 columns blog-pinterest-container"
						role="main">
						<div class="page-inner">
								...
								<article id="post-3322"
									...
									<div class="entry-content">
										...
										<span class="comments-link"><a
											...
											<a href="http://flatsome.uxthemes.com/tag/fashion/" rel="tag">fashion</a>,
								...
								<article id="post-474"
									...
									<div class="entry-image">
										<a
											...
											class="attachment-medium wp-post-image" alt="breezi_placeit" />
										</a>
										<div class="post-date large">
							...
							<div class="large-12 columns navigation-container"></div>
						</div>
						<!-- .page-inner -->
			...
			<script>
				jQuery(document).ready(
						function($) {
							imagesLoaded(document.querySelector('.page-inner'),
